# Sesión 4 — `$lookup` básico (repaso de semana-07)

> Ejercicios tomados de `semana-07/practica/agregaciones/sesion-4-ejercicios.md`. Se incluyen para repasar `$lookup` antes de hacer la sesión 3 nueva.
>
