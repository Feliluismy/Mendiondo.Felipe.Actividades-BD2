...
const libros = [
  {
    ...
    comentarios: [
      ...
      "Imprescindible de la literatura latinoamericana",
    ],
  ...
  },
  {
    ...
    puntuacion: 4.5,
    comentarios: [
      "Novela experimental revolucionaria",
      "Se puede leer de múltiples formas",
    ],
  ...
  },
  {
    ...
    puntuacion: 4.9,
    comentarios: [
      "Colección de relatos magistrales",
      "Cada cuento es una joya",
    ],
  ...
  },
  {
    ...
    puntuacion: 4.5,
    comentarios: [
      "Cuentos surrealistas brillantes",
      "Cortázar joven pero genial",
    ],
    genero: "Cuento fantástico",
  ...
  },
  {
    ...
    puntuacion: 4.2,
    comentarios: [
      "Clásico de la literatura venezolana",
...
try {
  ...
  print(
    `db.${name_collection}.find({autor: "Gabriel García Márquez"}).pretty()`,
  );
