# Sesión 5 — Pipelines combinados (`$lookup` + `$group` + `$unwind`)

> **Tema:** combinar lo aprendido en las sesiones anteriores. `$lookup` con casos borde, `$unwind` sobre arrays embebidos, `$group` final.
>
